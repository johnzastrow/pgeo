...
pgeo 0.7.0, project 0.20.0, commit `1f7de80 (with uncommitted changes)`.
...
- [1. Why a second region is a test and not a feature](#1-why-a-second-region-is-a-test-and-not-a-feature)
- [2. What a build is now](#2-what-a-build-is-now)
  - [2.1 Facts that became rules](#21-facts-that-became-rules)
- [3. Performance: the build is 3.7 times faster](#3-performance-the-build-is-37-times-faster)
- [4. Correctness found on the way](#4-correctness-found-on-the-way)
  - [4.1 A geocoder for Maine held places in Canada](#41-a-geocoder-for-maine-held-places-in-canada)
...
- [5. Accuracy](#5-accuracy)
  ...
  - [5.6 The test the two front ends needed](#56-the-test-the-two-front-ends-needed)
...
- [9. What this means for the study report](#9-what-this-means-for-the-study-report)
