...
`8c6cacf (with uncommitted changes)` · data snapshot 2026-09-19 · load-test runs 20260918-1834, 20260918-2051, 20260919-0718, 20260919-1135-pgeo, 20260919-1543-pgeo.
...
the containers themselves need only 0.60 GB, so a 1 GB plan can work -- but only
