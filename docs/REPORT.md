...
pgeo 0.7.0, project 0.13.0, commit `2549be6 (with uncommitted changes)` ·
...
**Table 49. Which tool for which scenario.**
...
**Table 50. Work not done, with the effort, the likelihood it pays off and the value of finishing it.**
...
**Table 51. Phonetic misspellings against the deployed pgeo.** All five resolve, but two are weak: "Kenebunc" is found with low confidence, and "Skowhegin" ranks a venue above the town.
...
**Table 52. How coarse each phonetic encoding is on this data.** Soundex puts 18 distinct towns -- North Bancroft, Northport, North Haven, Northfield and fourteen more -- into one bucket.
...
**Table 53. Questions asked during the project, with short answers and the sections that answer them in full.**
...
**Table 54. pgeo tables (including their indexes).**
