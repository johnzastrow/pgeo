...
pgeo 0.7.0, project 0.12.2, commit `a89ae9c (with uncommitted changes)` ·
...
**Table 39. Questions asked during the project, with short answers and the sections that answer them in full.**
...
**Table 40. pgeo tables (including their indexes).**
