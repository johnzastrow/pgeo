...
Project version 0.12.0 (pgeo 0.7.0) · built 2026-09-19 from commit
`3d44b23 (with uncommitted changes)` · data snapshot 2026-09-19 · load-test runs 20260918-1834, 20260918-2051, 20260919-0718, 20260919-1135-pgeo, 20260919-1543-pgeo.
...
closely enough that an existing client cannot tell the difference (27 of
27 contract cases). What it gives up is throughput -- a quarter of Pelias's
