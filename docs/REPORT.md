...
pgeo 0.7.0, project 0.16.0, commit `57b463f (with uncommitted changes)` ·
...
**Table 54. Which tool for which scenario.**
...
**Table 55. Work not done, with the effort, the likelihood it pays off and the value of finishing it.**
...
**Table 56. Phonetic misspellings against the deployed pgeo.** All five resolve, but two are weak: "Kenebunc" is found with low confidence, and "Skowhegin" ranks a venue above the town.
...
**Table 57. How coarse each phonetic encoding is on this data.** Soundex puts 18 distinct towns -- North Bancroft, Northport, North Haven, Northfield and fourteen more -- into one bucket.
...
**Table 58. Questions asked during the project, with short answers and the sections that answer them in full.**
...
**Table 59. pgeo tables (including their indexes).**
