...
pgeo 0.7.0, project 0.14.0, commit `f85ff57 (with uncommitted changes)` ·
...
January 2018[3], the hosted services went with it -- but the code did not:
members of the same team founded Geocode Earth that month and have maintained the project
since[4, 5]. It remains actively developed in 2026, under
the MIT licence[6], with a community of business and individual contributors.
...
Nominatim[7] and Photon[8] are OpenStreetMap only; the TIGER
...
| Nominatim[7] | indexing and address computation in PL/pgSQL triggers; **search in a Python application** | OpenStreetMap | HTTP API | Postgres-centric rather than Postgres-only. Version 5 completed the move from PHP to Python. Planet-scale: ~1 TB of disk and 128 GB-class memory; the 2025 roadmap[17] notes search indexes have grown large enough to slow lookups |
...
on every configuration, and Photon[8] is the engine built specifically to do
...
database[7]. The Maine OpenStreetMap extract was imported into Nominatim 4.5
...
Nominatim[7] is the OpenStreetMap geocoder -- the one that answers
...
3. Pelias open-source project update, 2 January 2018 (the Mapzen shutdown announcement). <https://pelias.io/announcements/2018-01-02-pelias-update/>
4. Geocode Earth: the company founded in January 2018 by former Mapzen staff, which maintains Pelias. <https://geocode.earth/opensource/>
5. A trip down memory lane, Geocode Earth, 2020. <https://geocode.earth/blog/2020/memory-lane/>
6. Pelias is released under the MIT License. <https://github.com/pelias/pelias/blob/master/LICENSE>
7. Nominatim architecture overview, release 5.3 documentation. <https://nominatim.org/release-docs/latest/develop/overview/>
8. Photon: an open-source geocoder for OpenStreetMap data. <https://github.com/komoot/photon>
