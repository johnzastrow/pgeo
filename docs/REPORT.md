...
pgeo 0.7.0, project 0.12.2, commit `41c00a0 (with uncommitted changes)` ·
...
|:--|:--|:-:|:-:|:-:|
| search basic | `/v1/search?text=389 Congress St, Portland, ME` | pass | FAIL | pass |
| search properties | `/v1/search?text=389 Congress St, Portland, ME` | pass | FAIL | pass |
| search focus | `/v1/search?text=main st&focus.point.lat=44.8016&focus.point.lon=-68.7712` | pass | FAIL | pass |
| search boundary.rect | `/v1/search?text=main st&boundary.rect.min_lat=44.7&boundary.rect.max_lat=44.9&boundary.rect.min_lon=-68.9&boundary.rect.max_lon=-68.6` | pass | FAIL | pass |
| search boundary.circle | `/v1/search?text=main st&boundary.circle.lat=44.8016&boundary.circle.lon=-68.7712&boundary.circle.radius=15` | pass | FAIL | pass |
| search circle + focus | `/v1/search?text=main st&boundary.circle.lat=44.8016&boundary.circle.lon=-68.7712&boundary.circle.radius=15&focus.point.lat=44.8016&focus.point.lon=-68.7712` | pass | FAIL | pass |
| search boundary.gid | `/v1/search?text=congress st&boundary.gid=whosonfirst:locality:85948877` | pass | FAIL | pass |
| search boundary.country USA | `/v1/search?text=bangor&boundary.country=USA` | pass | FAIL | pass |
| search boundary.country FRA | `/v1/search?text=bangor&boundary.country=FRA` | pass | FAIL | pass |
| search layers+sources | `/v1/search?text=portland&layers=locality&sources=wof` | pass | FAIL | pass |
| search lang + api_key | `/v1/search?text=bangor&lang=en&api_key=abc123` | pass | FAIL | pass |
| search size | `/v1/search?text=main st&size=3` | pass | FAIL | pass |
| structured | `/v1/search/structured?address=389 Congress St&locality=Portland&region=ME` | pass | FAIL | pass |
| structured circle | `/v1/search/structured?address=Main St&boundary.circle.lat=44.8016&boundary.circle.lon=-68.7712&boundary.circle.radius=15` | pass | FAIL | pass |
| autocomplete | `/v1/autocomplete?text=389 congress` | pass | FAIL | pass |
| autocomplete circle | `/v1/autocomplete?text=main&boundary.circle.lat=44.8016&boundary.circle.lon=-68.7712&boundary.circle.radius=15` | pass | FAIL | pass |
| autocomplete gid | `/v1/autocomplete?text=congress&boundary.gid=whosonfirst:locality:85948877` | pass | FAIL | pass |
| reverse | `/v1/reverse?point.lat=43.6568&point.lon=-70.2626` | pass | FAIL | pass |
| reverse radius | `/v1/reverse?point.lat=43.6568&point.lon=-70.2626&boundary.circle.radius=1` | pass | FAIL | pass |
| reverse properties | `/v1/reverse?point.lat=43.6568&point.lon=-70.2626&layers=address` | pass | FAIL | pass |
| reverse country | `/v1/reverse?point.lat=43.6568&point.lon=-70.2626&boundary.country=US` | pass | FAIL | pass |
| place | `/v1/place?ids=whosonfirst:locality:85948877` | pass | FAIL | pass |
| attribution | `/v1/attribution?` | pass | FAIL | pass |
| error: search without text | `/v1/search?` | pass | FAIL | pass |
| error: bad focus | `/v1/search?text=x&focus.point.lat=999&focus.point.lon=0` | differs | FAIL | pass |
| error: bad layer | `/v1/search?text=x&layers=planet` | pass | FAIL | pass |
| error: reverse without point | `/v1/reverse?` | pass | FAIL | pass |
| error: circle without lon | `/v1/search?text=x&boundary.circle.lat=44.8` | pass | FAIL | pass |
