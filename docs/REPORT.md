...
`a37a8d5 (with uncommitted changes)` · data snapshot 2026-09-19 · load-test runs 20260918-1834, 20260918-2051, 20260919-0718, 20260919-1135-pgeo, 20260919-1543-pgeo.
...
**Table 31.** Which tool for which scenario.
...
**Table 32.** Questions asked during the project, with short answers and the sections that answer them in full.
...
**Table 33.** pgeo tables (including their indexes).
