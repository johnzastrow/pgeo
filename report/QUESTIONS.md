...
| 13 | We need to test pgeo on the Proxmox VM for accurate tests, right? | 2.5, 3.11 | answered |
...
| 32 | Is Pelias still the canonical thing to compare against for features, functions, scalability and flexibility? | 1.5.1 | answered (yes for features and flexibility; only partly for scalability - Photon untested) |
